...
from prcore.helpers import *


class SatisfyMessageView(views.APIView):
    authentication_classes = (TokenAuthentication,)
    # Read-only configuration text — managers and admins need it too.
    permission_classes = (PRReadPermission,)
...
class QuestionModelViewSet(mixins.ListModelMixin, viewsets.GenericViewSet):
    ...
    authentication_classes = (TokenAuthentication,)
    # List-only viewset: the questionnaire definition, not patient data.
    permission_classes = (PRReadPermission,)
